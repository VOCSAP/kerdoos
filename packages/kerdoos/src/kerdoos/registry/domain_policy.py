...
constructs its DomainPolicy and hands it to every caller (YamlConfigStore's
`_validate_url`, StaticRouter, and -- transitively -- every Fetcher adapter),
so the 6 registrable domains are declared exactly once.
