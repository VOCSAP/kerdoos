...
two, since autolycos never imports kerdoos (extractibility invariant).
"""
...
class FixturePrivacyTest(unittest.TestCase):
    ...
    def test_positive_control_each_pattern_is_detected(self) -> None:
        ...
        witnesses = [
            ...
            ("latitude", '{"latitude":-12.3456789}'),
            ("longitude", '{"longitude":-45.6789012}'),
            ("ak.ak", '{"ak.ak":"qXsynthBeaconValueForTest0987=="}'),
            ...
            ("mixed-case Latitude", '{"Latitude":-12.3456789}'),
            ("3-decimal latitude", '{"latitude":-12.345}'),
            ("lon", '{"lon":-45.6789012}'),
            ("long", '{"long":-45.6789012}'),
    ...
    def test_negative_controls_stay_clean(self) -> None:
        witnesses = [
            ...
            ("city-precision latitude", '{"latitude":-19.55}'),
            ("city-precision longitude", '{"longitude":-40.12}'),
